...
class OpticalCustomerDetails extends StatelessWidget {
  final TextEditingController nameController;
  final TextEditingController locationController;
  final Function(String, dynamic) onDynamicValueChanged;

  const OpticalCustomerDetails({
    super.key,
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              onChanged: (value) => onDynamicValueChanged('age', value),
            ),
            const SizedBox(height: 16),
            TextFormField(
              decoration: InputDecoration(
                labelText: context.l10n.guardianName,
                border: const OutlineInputBorder(),
              ),
              onChanged: (value) =>
                  onDynamicValueChanged('guardianName', value),
            ),
          ],
        ),
      ),
